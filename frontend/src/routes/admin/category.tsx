...
const getInputMask = (index: number) => {
  switch (index) {
    case 0:
      return 0b11000000;
    case 1:
    ...
    <div
      ...
      classList={{
        "border-dashed light:border-dark/10 dark:border-light/10 border-3":
          status().available,
        "light:bg-dark/5": !status().available,
      }}
    >
...
export default function SpeciesCategory() {
  ...
  const [categoryStore, setCategoryStore] = createStore<{
    order: Approach;
    family: Approach;
    genus: Approach;
  }>({
    order: { useExists: true, useInput: false },
    family: { useExists: true, useInput: false },
    genus: { useExists: false, useInput: true },
  });
  ...
  return (
    <>
      <div class="h-full">
        ...
        <figure class="h-full" id="container"></figure>
        <Modal
          opened={isOpen()}
          onClose={onClose}
