import { Button, IconButton, ListIcon, useColorMode } from "@hope-ui/solid";
import { JSX } from "solid-js";
import { Title } from "solid-start";
import Counter from "~/components/Counter";
import { LogoIcon } from "~/components/LogoIcon";

export function MaterialSymbolsDarkMode(
...
export function MaterialSymbolsLightMode(
  props: JSX.IntrinsicElements["svg"],
  key: string
) {
  return (
      ...
      <header class="sticky top-0 ">
        <div class="backdrop-blur-md">
          <nav class="inline flex container-compact items-center py-4">
            ...
            <ul class="flex gap-8 flex-1 items-center justify-center font-500 text-xl">
              <NavItem>主页</NavItem>
